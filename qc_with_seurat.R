...
dir_list  <- set_dir_with_10x_cellRanger(data_name)
...
for (f in file_list) {
  ...
  rm(seu_basic, seu_qc, md, thr_df, keep, n_before, n_after, fname, sample_id)
  gc()
